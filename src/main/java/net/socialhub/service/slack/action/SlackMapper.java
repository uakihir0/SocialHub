...
import static net.socialhub.service.slack.define.SlackMessageSubType.BotMessage;
    ...
    public static Comment comment(
        ...
        if (SlackMessageSubType.BotMessage.getCode().equals(message.getSubtype())) {
            ...
            for (Attachment attachment : message.getAttachments()) {
                ...
                model.setText(AttributedString.plain(builder.toString(), SlackAttributedTypes.simple()));
            }

        } else {

            // 通常のメッセージの場合
            model.setText(AttributedString.plain(message.getText(), SlackAttributedTypes.simple()));
        }
